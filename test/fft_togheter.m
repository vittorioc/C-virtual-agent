...
xlim([0 dmax]);
subplot8 = subplot(2,1,2,'Parent',figure1);
box(subplot8,'on');
hold(subplot8,'all');
E2P1 = ceil(abs(E2_half) - tolerance);
E2P2 = round(E2P1 ./ (E2P1+1));
E2P = angle(E2_half).*E2P2;
plot(f_half,E2P,'Parent',subplot8);
xlim([0 dmax]);

E3 = fft(e3);
E3_half = E3(1:N/2);

subplot3 = subplot(2,1,1,'Parent',figure1);
box(subplot3,'on');
hold(subplot3,'all');
E3M = abs(E3_half)*2/N; 
E3M(1) = E3M(1)/2;
...
xlim([0 dmax]);
subplot9 = subplot(2,1,2,'Parent',figure1);
box(subplot9,'on');
hold(subplot9,'all');
E3P1 = ceil(abs(E3_half) - tolerance);
E3P2 = round(E3P1 ./ (E3P1+1));
E3P = angle(E3_half).*E3P2;
plot(f_half,E3P,'Parent',subplot9);
xlim([0 dmax]);

E4 = fft(e4);
E4_half = E4(1:N/2);

subplot4 = subplot(2,1,1,'Parent',figure1);
box(subplot4,'on');
hold(subplot4,'all');
E4M = abs(E4_half)*2/N; 
E4M(1) = E4M(1)/2;
...
xlim([0 dmax]);
subplot10 = subplot(2,1,2,'Parent',figure1);
box(subplot10,'on');
hold(subplot10,'all');
E4P1 = ceil(abs(E4_half) - tolerance);
E4P2 = round(E4P1 ./ (E4P1+1));
E4P = angle(E4_half).*E4P2;
plot(f_half,E4P,'Parent',subplot10);
xlim([0 dmax]);

E5 = fft(e5);
E5_half = E5(1:N/2);

subplot5 = subplot(2,1,1,'Parent',figure1);
box(subplot5,'on');
hold(subplot5,'all');
E5M = abs(E5_half)*2/N; 
E5M(1) = E5M(1)/2;
...
xlim([0 dmax]);
subplot11 = subplot(2,1,2,'Parent',figure1);
box(subplot11,'on');
hold(subplot11,'all');
E5P1 = ceil(abs(E5_half) - tolerance);
E5P2 = round(E5P1 ./ (E5P1+1));
E5P = angle(E5_half).*E5P2;
plot(f_half,E5P,'Parent',subplot11);
xlim([0 dmax]);

E6 = fft(e6);
E6_half = E6(1:N/2);

subplot6 = subplot(2,1,1,'Parent',figure1);
box(subplot6,'on');
hold(subplot6,'all');
E6M = abs(E6_half)*2/N; 
E6M(1) = E6M(1)/2;
...
plot(f_half,E6P,'Parent',subplot12);
xlim([0 dmax]);